...
i10
species10 <- basename(dirs_spp)[i10]
...
for (i in 1:length(species_2)){
  dir.create(file.path(train_2_dir, str_sub(species2[[i]], start = 1, end = 5)))
  dir.create(file.path(validation_2_dir, str_sub(species2[[i]], start = 1, end = 5)))
  dir.create(file.path(test_2_dir, str_sub(species2[[i]], start = 1, end = 5)))
}
```
